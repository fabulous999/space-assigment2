...
import ring = THREE.RingGeometry;
//Custom Game Objects
...
var step: number = 0;
var ambientColour;
var sphereMaterial: LambertMaterial, earthMaterial: LambertMaterial ;
...
var ringgeo = new THREE.RingGeometry , ringmesh : THREE.Mesh , ringmat : THREE.Material;

//planet/moon 
var earth : Mesh , moon : Mesh, uranus : Mesh ,mars :Mesh, mercury:Mesh, venus:Mesh , jupiter:Mesh, saturn:Mesh , neptune : Mesh;
//button function
...
//orbit ring
var ringearthgeo = new THREE.RingGeometry , ringearhtmesh : THREE.Mesh , ringearthmat : THREE.Material;
var ringmercarygeo = new THREE.RingGeometry , ringmercarymesh : THREE.Mesh , ringmercarymat : THREE.Material;
var ringvenusgeo = new THREE.RingGeometry , ringvenusmesh : THREE.Mesh , ringvenusmat : THREE.Material;
var ringmarsgeo = new THREE.RingGeometry , ringmarsmesh : THREE.Mesh , ringmarsmat : THREE.Material;
var ringjupitergeo = new THREE.RingGeometry , ringjupitermesh : THREE.Mesh , ringjupitermat : THREE.Material;
var ringsaturngeo = new THREE.RingGeometry , ringsaturnmesh : THREE.Mesh , ringsaturnmat : THREE.Material;
var ringuranusgeo = new THREE.RingGeometry , ringuranusmesh : THREE.Mesh , ringuranusmat : THREE.Material;
var ringneptunegeo = new THREE.RingGeometry , ringneptunemesh : THREE.Mesh , ringneptunemat : THREE.Material;
...
//planet geo
var spheregeo : SphereGeometry, earthgeo : SphereGeometry , moongeo : SphereGeometry, uranusgeo : SphereGeometry , marsgeo : SphereGeometry, mercurygeo : SphereGeometry, venusgeo : SphereGeometry ,jupitergeo : SphereGeometry;
var saturngeo : SphereGeometry , neptunegeo : SphereGeometry;
...
function init() {
   ...
   // plane = new gameObject(
     //   new PlaneGeometry(16, 16, 1, 1),material, 0, 0, 0);
        plane = new gameObject(
        new PlaneGeometry(20, 40), earthtext ,0, 0, 0);
